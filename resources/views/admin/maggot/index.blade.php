@extends('layouts.admin.master.maggot')

@section('Title', 'Dashboard')
@section('MainMenu', 'Dashboard Admin')
@section('PageTitle', 'Maggot')
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-success card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="font-weight-bold text-muted font-size-sm">Artikel</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 25-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-danger card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">2</span>
                    <span class="font-weight-bold text-muted font-size-sm">Infografis</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 26-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-info card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">20</span>
                    <span class="font-weight-bold text-muted font-size-sm">Foto</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 27-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-warning card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="font-weight-bold text-muted font-size-sm">Video</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stat: Widget 28-->
